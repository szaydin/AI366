...
n = [0.0] * numTilings * 121   # initialize the total number of tiles across all tilings here
theta = n    # initialize weights appropriately here
...
def learn(in1, in2, target):
	...
	learned_f = f(in1,in2)
	for i in tileIndices:
		theta[i] = theta[i] + alpha*(target - learned_f)
